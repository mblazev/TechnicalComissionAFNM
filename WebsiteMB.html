...
<body>
  ...
  <nav>
    <ul>
      ...
      <li><a href="#profesional experience">Profesional Experience</a></li>
      <li><a href="#portfolio">Portfolio</a></li>
      <li><a href="#blog">Blog</a></li>
      <li><a href="#contact">Contact</a></li>
      <li><a href="#profesional_experience">Profesional Experience</a></li>
    </ul>
  </nav>
  ...
  <main>
    <section id="about">
      ...
      <section id="profesional_experience">
...
President, Technical Commission</p>


            <h3>Automobile Federation of North Macedonia (2023–Present)</h3>
...
Chief Mechanical Scrutineer</p>

             <h3>Formula Student Alpe Adria, Czech Republic, and Portugal (2023–Present)</h3>
    ...
    <section id="contact">
      <h2>Contact</h2>
      <p>Email: blazevskimario1@gmail.com
